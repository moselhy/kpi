# Generated by Django 2.2.7 on 2020-10-28 02:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='asset',
            name='last_accessed',
            field=models.DateTimeField(null=True), # making it initially nullable adds the column to the schema
            preserve_default=False,
        ),
        migrations.RunPython(set_default_access_time),
    ...
    def set_default_access_time(apps, editor):
        Asset = apps.get_model('kpi', 'Asset')
        for asset in Asset.objects.all().iterator():
            asset.last_accessed = asset.date_modified
            asset.save()
